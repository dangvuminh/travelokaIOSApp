...
struct FlightSearch: View {
    ...
    var body: some View {
        VStack {
            ...
            Text("Recent search").font(.system(size: 15.0)).frame(maxWidth: .infinity, alignment: .leading).background(Color.gray)
                List {
            ...
            Text("Popular cities or airports").font(.system(size: 15.0)).frame(maxWidth: .infinity, alignment: .leading).background(Color.gray)
                List {
                    CityAirportItem(city: "Ho Chi Minh city, Viet Nam", airport: "SGN - Tan Son Nhat airport")
                    CityAirportItem(city: "Taipei, Taiwan", airport: "TPE - Taoyuan airport")
                    CityAirportItem(city: "Hong Kong, Hong Kong", airport: "SGN - Hong Kong Intl airport")
